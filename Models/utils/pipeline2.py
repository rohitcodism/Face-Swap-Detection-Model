...
def modified_build_full_model():
    # Inputs
    facial_frames = Input(shape=(30, 224, 224, 3))  # Example input shape for facial_frames
    micro_expression_frames = Input(shape=(30, 64, 64, 3))  # Example input shape for micro_expression_frames
    ...
    # Temporal features
    temporal_features = temporal_model(spatial_features)
    micro_exp_temporal_features = micro_exp_temporal_model(micro_exp_spatial_features)
