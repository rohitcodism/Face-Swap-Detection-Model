...
from Models.utils.pipeline2 import build_full_model
...
with open('Models/data/video_data_main_2.pkl', 'rb') as f:
...
val_names, test_names, val_labels, test_labels = train_test_split(temp_names, temp_labels, test_size=0.7)
