...
def temporal_feature_extractor(input_seq):
    lstm_1 = Bidirectional(LSTM(128, return_sequences=True, dropout=0.2))(input_seq)
    lstm_2 = Bidirectional(LSTM(64, return_sequences=True, dropout=0.2))(lstm_1)
    return lstm_2

def micro_exp_temporal_inconsistency_detector(input_seq):
    lstm_1 = Bidirectional(LSTM(128, return_sequences=True, dropout=0.2))(input_seq)
    lstm_2 = Bidirectional(LSTM(64, return_sequences=True, dropout=0.2))(lstm_1)
...
def build_face_swap_detection_model(concatenated_feature_vector):
    ...
    op_face_swap = Dense(1, activation='sigmoid')(x_face_swap)  # Shape: (None, 1)
...
def build_full_model():
    ...
    # Temporal Features
    temporal_features = temporal_feature_extractor(spatial_features)  # Shape: (None, 30, 256)
    micro_exp_temporal_features = micro_exp_temporal_inconsistency_detector(micro_exp_spatial_features)  # Shape: (None, 30, 128)
